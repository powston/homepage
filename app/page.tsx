  ...
  return (
    <>
      <main>
        ...
        <section className="pb-20 bg-zinc-200 -mt-24">
          <div className="container mx-auto px-4">
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-zinc-500">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                <div className="text-zinc-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                  <i className="fas fa-user-friends text-xl"></i>
                </div>
                <h3 className="text-3xl mb-2 font-semibold leading-normal">
                  Intelligent Battery Management
                </h3>
                <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-zinc-600">
                ...
                <p className="text-lg font-light leading-relaxed mt-0 mb-4 text-zinc-600">
            ...
            <div className="items-center flex flex-wrap">
              <div className="w-full md:w-4/12 ml-auto mr-auto px-4">
                <img
                  ...
                  src="images/qld-run.jpg"
                />
              </div>
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  <div className="text-zinc-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-zinc-200">
                  ...
                  <ul className="list-none mt-6">
                    <li className="py-2">
                      <div className="flex items-center">
                        <div>
                          <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-zinc-500 bg-zinc-100 mr-3">
                            <i className="fas fa-fingerprint"></i>
                          </span>
                        </div>
                        <div>
        ...
        <section className="pb-20 relative block bg-zinc-800">
          <div
            className="bottom-auto top-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden -mt-20 h-20"
            style={{ transform: "translateZ(0)" }}
          >
          ...
          <div className="container mx-auto px-4 lg:pt-24 lg:pb-64">
            <div className="flex flex-wrap text-center justify-center">
              <div className="w-full lg:w-6/12 px-4">
                ...
                <p className="text-lg leading-relaxed mt-4 mb-4 text-zinc-400">
            ...
            <div className="flex flex-wrap mt-12 justify-center">
              <div className="w-full lg:w-3/12 px-4 text-center">
                <div className="text-zinc-800 p-3 w-12 h-12 shadow-lg rounded-full bg-white inline-flex items-center justify-center">
        ...
        <section className="relative block py-24 lg:pt-0 bg-zinc-800">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center lg:-mt-64 -mt-48">
              <div className="w-full lg:w-6/12 px-4">
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-zinc-200">
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <div className="text-center mt-6">
                      <a
                        className="bg-zinc-800 text-white active:bg-zinc-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"
                        href="mailto:info@powston.com"
                      >
                        Send Message
                      </a>
                    </div>
      ...
      <footer className="relative bg-zinc-200 pt-8 pb-6" />
    </>
  )
}
